...
putAnXBtn.onclick = function(){
 	...
 	// get a reference to the box
        ...
        var yPosition = Math.random() * parseInt(height); // should generate a value between 0 and the height
        var xPosition = Math.random() * parseInt(width);  //should generate a value between 0 and the width
